...
import { auth, db, SignInScreen } from "./utils/firebase";
...
export default function App() {
  ...
  const [currentUser, setcurrentUser] = useState<FirebaseUser | null>(null); // Local user info
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <AppBar position="absolute" open={open}>
          ...
          >
            ...
            >
              Signed in as{" "}
              {auth.currentUser ? auth.currentUser.displayName : "GenericUser"}
            </Typography>
            <Button
              variant="contained"
              size="small"
